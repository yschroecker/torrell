...
def _run():
    ...
    eval_tabular_policy = torrell.scripts.tabular.policy.TabularPolicy(grid.num_states, grid.num_actions, biased=False)
    ...
    tdv = torrell.critic.retrace.Retrace(v_network, sample_policy, eval_policy, 0.5)
